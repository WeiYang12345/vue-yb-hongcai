{
  ...
  output: {
    path: 'E:\\leihuo-hc-web\\pdist(20210114)',
    filename: 'static/js/[name].[chunkhash].1610626348112.js',
    publicPath: '/',
    chunkFilename: 'static/js/[name].[chunkhash].1610626348112.js'
  },
  resolve: {
    alias: {
      '@': 'E:\\leihuo-hc-web\\src',
      vue$: 'vue/dist/vue.runtime.esm.js',
      '@img': 'E:\\leihuo-hc-web\\src\\assets\\img',
      '@js': 'E:\\leihuo-hc-web\\src\\assets\\js'
    },
    extensions: [
      '.mjs',
      '.js',
    ...
    rules: [
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: 'E:\\leihuo-hc-web\\node_modules\\cache-loader\\dist\\cjs.js',
            options: {
              cacheDirectory: 'E:\\leihuo-hc-web\\node_modules\\.cache\\vue-loader',
              cacheIdentifier: '98fb6cb4'
            }
          },
  ...
  plugins: [
    ...
    new DefinePlugin(
      {
        'process.env': {
          NODE_ENV: '"production"',
          VUE_APP_API_TARGET: '"http://api.leihuo.dev.ipx-king.me"',
          VUE_APP_BASE_OUT_PUT_DIR_NAME: '"pdist"',
          BASE_URL: '"/"'
        }
      }
    ),
    ...
    new MiniCssExtractPlugin(
      {
        filename: 'static/css/[name].1610626348112.css',
        chunkFilename: 'static/css/[name].[chunkhash].1610626348112.css'
      }
    ),
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'E:\\leihuo-hc-web\\public\\index.html'
      }
    ),
    ...
    new CopyPlugin(
      [
        {
          from: 'E:\\leihuo-hc-web\\public',
          to: 'E:\\leihuo-hc-web\\pdist(20210114)',
          toType: 'dir',
          ignore: [
            '.DS_Store',
            {
